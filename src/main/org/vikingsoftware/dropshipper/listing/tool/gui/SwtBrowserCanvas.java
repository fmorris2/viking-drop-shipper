...
public final class SwtBrowserCanvas extends Canvas {
	 ...
	 *
	 */
	private static final long serialVersionUID = 1128055292260275474L;
    ...
    public boolean initialise() {
        final CountDownLatch browserCreatedLatch = new CountDownLatch(1);
        final SwtThread swtThread = new SwtThread(browserCreatedLatch);
    ...
    public void dispose() {
        ...
        final SwtThread swtThread = swtThreadReference.getAndSet(null);
        if (swtThread != null) {
            swtThread.interrupt();
        }
    }
