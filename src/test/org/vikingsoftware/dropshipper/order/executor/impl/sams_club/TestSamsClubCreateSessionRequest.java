...
import main.org.vikingsoftware.dropshipper.order.executor.strategy.impl.sams_club.requests.SamsClubCreateSessionRequest;

public class TestSamsClubCreateSessionRequest {
	...
	public void test() {
		...
		final SamsClubCreateSessionRequest request = new SamsClubCreateSessionRequest(client);
