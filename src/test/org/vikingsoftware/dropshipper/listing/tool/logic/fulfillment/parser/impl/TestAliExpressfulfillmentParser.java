...
public class TestAliExpressfulfillmentParser {
	...
	@Test
	public void test() {
		final FulfillmentAccount account = FulfillmentAccountManager.get().peekAccount(FulfillmentPlatforms.ALI_EXPRESS);
		...
		final Listing listing = AliExpressFulfillmentParser.get().getListingTemplate(account, url);
